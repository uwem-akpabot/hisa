...
const Dashboard = () => {
  return (
    <>
    <h1 className="h3 mb-3"><strong>Welcome to </strong>Dashboard</h1>    
    <div className="row">
                    ...
                    <div className="col-sm-6">
                        <div className="card">
                            <div className="card-body">
                                ...
                                <h1 className="mt-1 mb-3 text-primary"><b>2.382</b></h1>
                                <div className="mb-0">
                        ...
                        <div className="card">
                            <div className="card-body">
                                ...
                                <h1 className="mt-1 mb-3 text-success"><b>14.212</b></h1>
                                <div className="mb-0">
                    ...
                    <div className="col-sm-6">
                        <div className="card">
                            <div className="card-body">
                                ...
                                <h1 className="mt-1 mb-3 text-warning"><b>$21.300</b></h1>
                                <div className="mb-0">
                        ...
                        <div className="card">
                            <div className="card-body">
                                ...
                                <h1 className="mt-1 mb-3 text-danger"><b>64</b></h1>
                                <div className="mb-0">
        ...
        <div className="col-xl-6 col-xxl-7">
            <div className="card flex-fill w-100">
                <div className="card-header">
                    ...
                    <h5 className="card-title mb-0">Recent Records</h5>
                </div>
        ...
        <div className="col-12 col-lg-8 col-xxl-9 d-flex">
            <div className="card flex-fill">
                <div className="card-header">
                    ...
                    <h5 className="card-title mb-0">Patients' Details</h5>
                </div>
        ...
        <div className="col-12 col-lg-4 col-xxl-3 d-flex">
            <div className="card flex-fill w-100">
                <div className="card-header">
                    ...
                    <h5 className="card-title mb-0">Monthly Record</h5>
                </div>
